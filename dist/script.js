...
function () {
  function Difference(oldOfficer, newOfficer, items) {
    ...
    try {
      ...
      this.newItems = this.newItems = this.newOfficer.querySelectorAll(items);
      this.oldCounter = 0;
      this.newCounter = 0;
    } catch (e) {}
  }
...
/*#__PURE__*/
function () {
  function VideoPlayer(triggers, overplay) {
  ...
  _createClass(VideoPlayer, [{
        ...
        btn.addEventListener('click', function () {
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            ...
            if (document.querySelector('iframe#frame')) {
              _this.overplay.style.display = 'flex';
    ...
    value: function bindCloseBtn() {
      ...
      this.close.addEventListener('click', function () {
        _this2.overplay.style.display = 'none';
